...
| **🤖 Judge Accuracy** | `90.00%` | `40.00%` | `90.00%` |
| **⭐ Mean Judge Score** | `4.70 / 5.0` | `2.68 / 5.0` | `4.70 / 5.0` |
| **🎯 Ragas Context Precision** | `100.00%` | `40.00%` | `100.00%` |
| **📚 Ragas Context Recall** | `100.00%` | `40.00%` | `100.00%` |
| **🛡️ Ragas Faithfulness** | `100.00%` | `42.00%` | `100.00%` |
| **💬 Ragas Answer Relevancy** | `94.50%` | `41.50%` | `94.50%` |
