...
| **Truy vấn (Query)** | `agentic RAG` |
| **Bộ lọc (Filter)** | `from-pub-date:2026-02-07` |
...
* **🎯 Tỉ lệ tìm kiếm trúng (Retrieval Hit Rate):** `90.00%`
* **✍️ Điểm tương đồng từ vựng (Mean Token F1):** `78.00%`
* **🤖 Độ chính xác đánh giá (Judge Accuracy):** `85.00%`
* **⭐ Điểm trung bình đánh giá (Mean Judge Score):** `4.20 / 5.0`
...
* **Thời gian kiểm định:** `2026-08-06T09:59:50.904928`
* **Tổng số bản ghi kiểm định:** `3`

| Tên kiểm tra (Check Name) | Trạng thái (Status) | Kết quả quan sát (Observed) | Thông báo (Message) |
| :--- | :---: | :---: | :--- |
| **Row Count** | 🟢 **PASSED** | `3` | Passed: Found 3 records. |
...
* **Ngày xuất bản mới nhất (Latest Published Date):** `2026-07-01`
* **Ngày xuất bản cũ nhất (Oldest Published Date):** `2026-05-01`
* **Số lượng dòng cũ/lạc hậu (Stale Rows):** `0`
* **Tổng số dòng dữ liệu (Total Rows):** `3`
